  ...
  <div className="min-h-screen px-4 py-12">
   <div className="max-w-2xl mx-auto">
       ...
       <div className="min-w-0 flex-1">
        ...
        {!otpSent ? (
         <button
          ...
          onClick={requestOtp}
          disabled={otpBusy}
          className="mt-3 inline-flex items-center gap-2 bg-primary px-4 py-2 text-sm font-inter font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-60"
         >
         ...
         <div className="mt-3 space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2">
           ...
           <button
            ...
            className="inline-flex items-center gap-2 bg-primary px-4 py-2 text-sm font-inter font-semibold text-primary-foreground hover:bg-primary/90 disabled:opacity-60"
           >
    ...
    {isPending && seatingMode === 'reserved' && (() => {
     ...
     return expired ? (
      <div className="mt-6 flex items-start gap-3 border border-destructive/40 bg-destructive/10 p-4 text-destructive">
      ...
      <div className="mt-6 flex items-center gap-3 border border-amber-500/40 bg-amber-500/10 p-4 text-amber-700 dark:text-amber-400">
