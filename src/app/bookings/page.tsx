 ...
 return (
  <div className="pt-16 min-h-screen pb-24 bg-background">
   <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div className="mb-6 flex gap-2 p-1 w-fit bg-card border border-border">
      ...
      {filteredBookings.map((booking) => {
       ...
       return (
        <motion.div
         ...
         className="border border-border bg-card overflow-hidden transition-colors hover:border-primary/40"
        >
