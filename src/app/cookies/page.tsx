...
//   2. The third-party scripts/cookies users will encounter at checkout (Seylan MPGS)
...
const SECTIONS: { h: string; p: string[] }[] = [
  ...
  },
  {
    ...
    p: [
      "When you proceed to payment, you interact with our payment partner's hosted checkout (Seylan MPGS) which sets its own cookies on its domain to process the transaction securely. We do not control these cookies. See mastercard.com/gateway for their privacy practices.",
