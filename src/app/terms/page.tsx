...
const SECTIONS: { h: string; p: string[] }[] = [
  ...
  },
  {
    ...
    p: [
      "Ticket prices are set by the event organizer and shown at checkout. Payments are processed securely through our payment partner (PayHere). A booking is only confirmed once payment is successfully completed. Your e-ticket and QR code are issued to the email and phone number provided at checkout.",
    ],
  },
  {
